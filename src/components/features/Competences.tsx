...
export function Competences() {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative flex flex-col mt-32 md:mt-[400px] lg:mt-60 overflow-hidden"
      id="Competences"
    >
      <FloatingTechIcons />
      <SplitReveal
        as="h1"
        className="relative z-10 md:text-5xl text-4xl text-center mb-3 font3 text-[#0a001a] dark:text-[#efe5ff]"
      >
        🧠 Mes compétences
      </SplitReveal>
      <span className="relative z-10 text-2xl text-center mb-12 font3 bg-gradient-to-r dark:from-[#a877fd] dark:to-[#ff6fd8] from-[#330288] to-[#a877fd] bg-clip-text text-transparent">
        ✨ Principaux
      </span>
      ...
      <motion.div
        className="relative flex flex-col items-center font3 z-0"
        ref={ref}
        style={{ y }}
      >
        <span className="text-2xl text-center md:mt-52 mt-32 mb-2 font3 text-[#0a001a] dark:text-[#efe5ff]">
